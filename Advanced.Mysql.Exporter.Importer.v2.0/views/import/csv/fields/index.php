...
<div class="control-group">
    <label class="control-label">First CSV Row is Column Names <i class="icon-question-sign"></i></label>
...
<div class="control-group">
    <label class="control-label" for="csv_file">CSV File <i class="icon-file"></i></label>

    <div class="controls">
        <input type="file" id="csv_file" name="csv_file" class="input" required="required"/>
    </div>
</div>
