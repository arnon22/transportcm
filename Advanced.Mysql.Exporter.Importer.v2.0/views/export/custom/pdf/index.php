<div class="main-div-index">
    <form action="" id="export_form" class="form-horizontal export-step" method="post">
        <fieldset>
            <legend>Export Custom Query to PDF</legend>
            <?php
            ...
            <div class="control-group" id="field-list-div">
                ...
                <div class="control-group">
                    <label for="pdf_file_name" class="control-label">Output File Name <i class="icon-file"></i></label>

                    <div class="controls">
                        <input type="text" required="required" class="input" value="custom_pdf" name="pdf_file_name"
                               id="pdf_file_name">
                    </div>
                </div>
                <div class="control-group">

                    <input type="submit" class="btn" value="Export" name="submitExportCustomPDF" id="submitBtn">
                </div>
            </div>
</div>