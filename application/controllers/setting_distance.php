...
class Setting_distance extends CI_Controller {
    ...
    if($this->session->userdata('logged_in'))
   {
     ...
     $data_table ="distancecode";
     
     $config = array();
        $config["base_url"] = base_url() . "setting_distance/index";
        ...
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
           ...
           // $data["links"] = $this->pagination->create_links();
            ...
            $this->load->view("setting/distance_view", $data);
