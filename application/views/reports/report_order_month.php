...
<!-- /header-->
    ...
    <div class="clear"></div>
      <div class="row-fluid">		
        ...
        <div class="control-group">
        <label class="control-label"><?php echo $this->lang->line('car_number');?> </label>
        <div class="controls">
        <select name="carNumber">
        <option value="All"><?php echo $this->lang->line("All");?></option>
        <?php
        if(isset($car_number)){
            foreach($car_number as $rs){
                echo "<option value=\"{$rs['car_id']}\">{$rs['car_number']}</option>";
            }
