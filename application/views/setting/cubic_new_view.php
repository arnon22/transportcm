...
<!-- container -->
    <div class="container-fluid">
      ...
      <h2><?php echo $this->lang->line('cubic_h2_title')?></h2>
    ...
    <form class="form-search">
     ...
     <table class="table table-hover">
      ...
      <td><?php echo $i ?></td>
      <td><?php echo iconv('UTF-8','TIS-620',$cubic->cubic_value);?></td>
   
      <td><?php echo iconv('UTF-8','TIS-620',$cubic->cubic_note);?></td>
      <td><?php if(iconv('UTF-8','TIS-620',$cubic->cubic_status)=='0'){echo $this->lang->line('item_no_use');}else{ echo $this->lang->line('item_use');}?></td>
      <td>50</td>
