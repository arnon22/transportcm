...
<!-- container -->
    <div class="container-fluid">
      ...
      <h2><?php echo $this->lang->line('factory_title')?></h2>
    ...
    <form class="form-search">
     ...
     <table class="table table-hover">
      ...
      <td><?php echo $i ?></td>
      <td><?php echo iconv('UTF-8','TIS-620',$factory->factory_code);?></td>
      <td><?php echo iconv('UTF-8','TIS-620',$factory->factory_name);?></td>
      <td><?php echo iconv('UTF-8','TIS-620',$factory->factory_note);?></td>
      <td><?php if(iconv('UTF-8','TIS-620',$factory->factory_status)=='0'){echo $this->lang->line('item_no_use');}else{ echo $this->lang->line('item_use');}?></td>
      <td>50</td>
