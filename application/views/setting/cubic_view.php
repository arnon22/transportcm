...
echo form_open("setting/add_product");
...
?>
        ...
        echo iconv('UTF-8', 'TIS-620', $rew['products_code']);

?></td>
        <td><?php

        echo iconv('UTF-8', 'TIS-620', $rew['products_name']);

?></td>
        <td><?php

        echo iconv('UTF-8', 'TIS-620', $rew['products_note']);

?></td>
        <td><?php

        if (iconv('UTF-8', 'TIS-620', $rew['products_status']) == '0')
        {
            echo "ไม่ใช้งาน";
        } else
        {
...
?></td>
        ...
        echo $rew['products_id']

?>" class="pro_edit" href="javascript:void(0)" onclick="">Edit</a>| <a href="javascript:void(0)" onclick="del('<?php
