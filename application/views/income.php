...
<!-- /header-->
    ...
    <div class="span4">
        ...
        <button class="btn btn-success" type="button" onclick="$('#list2_iladd').click()"><?php echo $this->lang->line('new_data');?></button>
        <button class="btn btn-warning" type="button" onclick="$('#list2_iledit').click()"><?php echo $this->lang->line('edit_data');?></button>
...
function grid2_onload()
{
      var grid = $("#list2");
       ...
       grid.jqGrid('footerData','set', {note:'บาท',income_details: 'รวม: ',expense_details: 'รวม: ',total_amount: ''+parseFloat(Math.round(sum*100)/100).toFixed(2) });
