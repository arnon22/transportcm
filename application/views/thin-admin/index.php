...
<head>
    ...
    <?php echo css('bootstrap-responsive.min.css');?>
	<link href="assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <?php echo css('thin-admin/plugins/font-awesome/css/font-awesome.min.css');?>
	<link href="assets/css/style-metro.css" rel="stylesheet" type="text/css"/>
    <?php echo css('thin-admin/style-metro.css');?>
	<link href="assets/css/style.css" rel="stylesheet" type="text/css"/>
    <?php echo css('thin-admin/style.css');?>
	<link href="assets/css/style-responsive.css" rel="stylesheet" type="text/css"/>
    <?php echo css('thin-admin/style-responsive.css');?>
	<link href="assets/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
    <?php echo css('thin-admin/themes/default.css');?>
	<link href="assets/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css"/>
     <?php echo css('thin-admin/plugins/uniform/css/uniform.default.css');?>
	<!-- END GLOBAL MANDATORY STYLES -->
	<!-- BEGIN PAGE LEVEL PLUGIN STYLES --> 
	<link href="assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
    <?php echo css('thin-admin/plugins/gritter/css/jquery.gritter.css');?>
	<link href="assets/plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
    <?php echo css('thin-admin/plugins/bootstrap-daterangepicker/daterangepicker.css');?>
	<link href="assets/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css"/>
    <?php echo css('thin-admin/plugins/fullcalendar/fullcalendar/fullcalendar.css');?>
	<link href="assets/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>
    <?php echo css('thin-admin/plugins/jqvmap/jqvmap/jqvmap.css','screen');?>
	<link href="assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <?php echo css('thin-admin/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css','screen');?>
	<!-- END PAGE LEVEL PLUGIN STYLES -->
	<!-- BEGIN PAGE LEVEL STYLES --> 
	<link href="assets/css/pages/tasks.css" rel="stylesheet" type="text/css" media="screen"/>
     <?php echo css('thin-admin/pages/tasks.css','screen');?>
